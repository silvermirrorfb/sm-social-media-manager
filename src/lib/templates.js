...
export const QUESTION_TEMPLATES = [
  ...
  "Yes, we accept gift cards in-store! If you're having trouble with a gift card, email inquiries@silvermirror.com with the card details and order number.",
  "For group events, email inquiries@silvermirror.com with your group size and preferred location, and the events team will follow up!",
  ...
  "We're always hiring! View open roles and apply at https://silvermirror.com/careers ✨",
  "If you're running late, please call your location directly so they can adjust the schedule!",
  "For collaborations, please email inquiries@silvermirror.com with your handle, audience size, and deliverables!",
];
